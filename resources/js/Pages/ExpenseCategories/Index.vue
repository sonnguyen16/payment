...
const clearFilters = () => {
  search.value = ''
  is_active.value = ''
  router.get(route('admin.expense-categories.index'))
}
...
<template>
  <Head title="Quản lý danh mục chi" />
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Danh sách danh mục chi</h3>
          </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="(category, index) in categories.data" :key="category.id">
                    ...
                    <td>{{ category.expense_vouchers_count || 0 }}</td>
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <button
                          v-if="category.expense_vouchers_count === 0"
                  ...
                  <tr v-if="categories.data.length === 0">
                    <td colspan="7" class="text-center text-muted">
                      <i class="fas fa-inbox"></i> Chưa có danh mục chi nào
                    </td>
                  </tr>
                </tbody>
              </table>
