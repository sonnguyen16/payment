...
const submit = () => {
  form.put(route('admin.expense-categories.update', props.category.id))
}
</script>

<template>
  <Head title="Chỉnh sửa danh mục chi" />
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              ...
              <form @submit.prevent="submit">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      placeholder="Nhập tên danh mục chi"
                      required
                    />
                  ...
                  <div class="form-group">
                    ...
                    <textarea
                      ...
                      rows="3"
                      placeholder="Nhập mô tả danh mục chi"
                    ></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted"> Chọn màu sắc để phân biệt danh mục chi </small>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted">
                      Chỉ những danh mục được kích hoạt mới hiển thị khi tạo phiếu chi
                    </small>
                  </div>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <Link :href="route('admin.expense-categories.index')" class="btn btn-secondary ml-2"> Hủy </Link>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                  ...
                  <div>
                    <h5 class="mb-1">{{ form.name || 'Tên danh mục chi' }}</h5>
                    <p class="mb-0 text-muted">{{ form.description || 'Mô tả danh mục chi' }}</p>
                  </div>
                </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Thông tin sử dụng</h3>
              </div>
              <div class="card-body">
                <p><strong>Số phiếu chi:</strong> {{ category.expense_vouchers_count || 0 }}</p>
