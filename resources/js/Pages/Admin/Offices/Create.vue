  ...
  <AdminLayout>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thêm văn phòng</h1>
          </div>
          <div class="col-sm-6">
          ...
          <form @submit.prevent="submit">
            <div class="card-body">
              <div class="form-group">
                ...
                <input v-model="form.name" type="text" class="form-control" :class="{ 'is-invalid': form.errors.name }" placeholder="VD: Hồ Chí Minh" />
                <div v-if="form.errors.name" class="invalid-feedback">{{ form.errors.name }}</div>
              </div>

              <div class="form-group">
                <label>Địa chỉ</label>
                <textarea v-model="form.location" class="form-control" rows="3" placeholder="Nhập địa chỉ văn phòng"></textarea>
              </div>
            </div>
